						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
								...
								<li class="menu-section">
									<h4 class="menu-text">Advisor / Unit List</h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>
								</li> 								
								<li class="menu-item menu-item-active advisor" aria-haspopup="true">
									<a href="advisor" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								<li class="menu-item menu-item-active unit" aria-haspopup="true">
								...
								<li class="menu-item menu-item-active validation" aria-haspopup="true">
									<a href="validation" class="menu-link">
										...
										<span class="menu-text">Sales Validation</span>
									</a>
								</li>
								<li class="menu-item menu-item-active medallion" aria-haspopup="true">
									<a href="medallion" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<span class="menu-text">Medallion</span>
									</a>
								</li>
								<li class="menu-item menu-item-active macaulay" aria-haspopup="true">
									<a href="macaulay" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										...
										<span class="menu-text">Macaulay</span>
									</a>
								</li>


<!-- 								<li class="menu-section">
									<h4 class="menu-text">Advisor</h4>
									<i class="menu-icon ki ki-bold-more-hor icon-md"></i>
								</li> -->
